...
function DockItem({
	...
	return (
		<motion.div
			...
			onClick={onClick}
			className={`relative inline-flex items-center justify-center rounded-full bg-[#1C7ED6] shadow-2xl ${className}`}
			tabIndex={0}
	...
	return (
		...
		>
			<motion.div
				...
				className={`${className} absolute bottom-3 left-1/2 transform -translate-x-1/2 flex items-end w-fit gap-4 rounded-2xl`}
